(function () {
  ...
  const apartmentHeating = (profile) => profile.S1 === "apartment" && profile.S2 === "district";
  ...
  const QUESTIONS = [
    ...
    { code: "E3", category: "electricity_awareness", text: "Peržiūriu savo elektros energijos suvartojimo palyginimą su panašiais objektais, jei energijos tiekėjas tokį pateikia.", condition: always, allowNA: true, naLabel: "Tokio palyginimo negaunu" },
    ...
    { code: "E6", category: "electricity_management", text: "Žinau, kaip pakeisti dažniausiai naudojamų buitinių prietaisų nustatymus, kad jie naudotų mažiau energijos.", condition: always, allowNA: false },
    { code: "E7", category: "electricity_management", text: "Nepalieku įjungtų ar budėjimo režime nenaudojamų prietaisų.", condition: always, allowNA: false },
    { code: "E8", category: "electricity_management", text: "Žinau, kokią informaciją parodo buitinių prietaisų energijos vartojimo efektyvumo etiketė.", condition: always, allowNA: false },
    ...
    { code: "H2", category: "heating", text: "Naudoju turimas temperatūros reguliavimo galimybes.", condition: canRegulate, allowNA: false },
    ...
    { code: "H5", category: "heating", text: "Rūpinuosi savo šildymo įrangos technine priežiūra.", condition: heatsIndividually, allowNA: false },
    ...
    { code: "H8", category: "heating", text: "Žinau, kokie viso namo lygmeniu sprendimai gali reikšmingai sumažinti šilumos energijos vartojimą.", hint: "Pavyzdžiui: šildymo sistemos balansavimas, šilumos punkto atnaujinimas ar pastato renovacija.", condition: apartmentHeating, allowNA: false },
